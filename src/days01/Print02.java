...
public class Print02 {
	...
	public static void main(String[] args) {
		...
		// 출력양식기호(d, s, f 등)와 실제 데이터 자료형이 마지 않으면 일부 에러를 발생시킵니다
		// System.out.printf("%d\n" , 23.45);   // 에러
		// System.out.printf("%f\n" , 23);  // 에러
		
		// 소수점을 조절하여 출려하려면 아래와 같이 씁니다
		System.out.printf("%d ÷ %d = %.2f\n", 27, 13, 27/13.0 );
		// 소수점 조절에 의해 자리수가 조절되고, 없어지는 곳은 반올림됩니다. - 위는 소수점 세째자리에서 반올림.
	}
